	...
	<div class="container">
		<div class="row">
			<div class="card" style="width: 18rem;">
				<img src="https://img.icons8.com/color/286/000000/dog.png"
					class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Dogs Pequeno Porte</h5>
			...
			<div class="card" style="width: 18rem;">
				<img src="https://img.icons8.com/color/286/000000/dog.png"
					class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Dogs M&eacute;dio Porte</h5>
					<p class="card-text">Some quick example text to build on the
						card title and make up the bulk of the card's content.</p>
					<a href="#" class="btn btn-primary">Go somewhere</a>
				</div>
			...
			<div class="card" style="width: 18rem;">
				<img src="https://img.icons8.com/color/286/000000/dog.png"
					class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Dogs Grande Porte</h5>
					<p class="card-text">Some quick example text to build on the
						card title and make up the bulk of the card's content.</p>
					<a href="#" class="btn btn-primary">Go somewhere</a>
				</div>
